...
R9_Cities <- read_csv(paste0(wd, 'DryWeatherLoadingCalcs/Input/juris_area_summary.csv')) %>%
...
write_csv(landuse_trib_202223, paste0(wd, '/Output/landuse_trib_202223.csv'))
...
event_total <- dr_rain %>%
  ...
  saveRDS(EMCRainTot2, file = paste0(wd, '/WetWeatherLoadingCalcs/Output/EMCRainTot2.rds')) 
  write_csv(EMCRainTot2, paste0(wd, '/WetWeatherLoadingCalcs/Output/EMCRainTot2.csv')) 

 
 #jurisdictional land-use
  
landuse_jurisdiction_2022 <- read_csv(paste0(wd, '/juris_lu_summary.csv'))  
...
#%>% 
#ungroup()
write_csv(landuse_lspc_juris_2023, paste0(getwd(), '/A.2 Outfall Assessments/WetWeatherLoadingCalcs/Output/landuse_lspc_juris_2022.csv'))
...
saveRDS(stn_emc, file = here('A.2 Outfall Assessments/WetWeatherLoadingCalcs/Output/stn_emc.rds'))
write_csv(stn_emc, path = here('A.2 Outfall Assessments/WetWeatherLoadingCalcs/Output/stn_emc.csv'))
...
values <- list() 
values[['EMC_M']] <- 'A.2 Outfall Assessments/WetWeatherLoadingCalcs/Output/EMC_M.rds'
